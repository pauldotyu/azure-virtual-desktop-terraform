...
resource "azurerm_virtual_machine_extension" "avd" {
  ...
  protected_settings = <<PROTECTED_SETTINGS
    {
      "commandToExecute": "powershell.exe -ExecutionPolicy Bypass -Command \"Set-NetFirewallProfile -Profile Domain,Public,Private -Enabled False; ./ConfigureRemotingForAnsible.ps1 -SkipNetworkProfileCheck -Verbose; Set-NetFirewallProfile -Profile Domain,Public,Private -Enabled True; exit 0;\""
    }
  PROTECTED_SETTINGS
